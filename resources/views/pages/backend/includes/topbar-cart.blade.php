<div class="kt-header__topbar-item dropdown">
  ...
  <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
    <form>
      ...
      <!-- begin:: Mycart -->
      <div class="kt-mycart">
        <div class="kt-mycart__head kt-head" style="background-image: url(/assets/backend/media/misc/bg-1.jpg);">
          ...
          <div class="kt-mycart__item">
            <div class="kt-mycart__container">
              ...
              <a href="#" class="kt-mycart__pic">
                <img src="/assets/backend/media/products/product9.jpg" title="">
              </a>
            </div>
          </div>
          <div class="kt-mycart__item">
            <div class="kt-mycart__container">
              ...
              <a href="#" class="kt-mycart__pic">
                <img src="/assets/backend/media/products/product13.jpg" title="">
              </a>
            </div>
          </div>
          <div class="kt-mycart__item">
            <div class="kt-mycart__container">
              ...
              <a href="#" class="kt-mycart__pic">
                <img src="/assets/backend/media/products/product16.jpg" title="">
              </a>
            </div>
          </div>
          <div class="kt-mycart__item">
            <div class="kt-mycart__container">
              ...
              <a href="#" class="kt-mycart__pic">
                <img src="/assets/backend/media/products/product15.jpg" title="" alt="">
              </a>
            </div>
          </div>
        </div>
