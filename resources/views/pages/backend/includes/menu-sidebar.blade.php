    ...
    <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true" data-kt-menu-expand="false">
      <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
        ...
        <div data-kt-menu-trigger="click" class="menu-item">
          <span class="menu-link">
            ...
            <div class="btn btn-xs btn-dark ms-2 fs-8 py-1 px-3"> NEW </div>
            <span class="menu-arrow"></span>
          </span>
        </div>
      </div>
      ...
      <div data-kt-menu-trigger="click" class="menu-item">
        <span class="menu-link">
          ...
          <span class="menu-title"> EXILEDNONAME </span>
        </span>
      </div>

      <div class="menu-item">
        <div class="menu-content pt-8 pb-2">
          <span class="menu-section text-muted text-uppercase fs-8 ls-1"> EXTENSIONS </span>
        </div>
      </div>
      ...
      <div class="menu-item">
        <div class="menu-content pt-8 pb-2">
          <span class="menu-section text-muted text-uppercase fs-8 ls-1"> PERMISSIONS </span>
        </div>
      </div>
        ...
        <div class="menu-sub menu-sub-accordion">
          ...
          <div class="menu-item">
            <a class="menu-link" href="../../demo1/dist/apps/user-management/permissions.html">
              ...
              <span class="menu-title"> F2A </span>
            </a>
          </div>
        </div>
      </div>
