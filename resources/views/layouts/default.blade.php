...
<html lang="en">
  ...
  <body>
    ...
    @include('pages.backend.includes.sidebar-right')
            ...
            <div class="card shadow-base bd-0">
              <div class="card-header bg-transparent d-flex justify-content-between align-items-center">
                ...
                <span class="tx-12 tx-uppercase">
                  ...
                  <div class="dropdown-menu dropdown-menu-right pd-10" x-placement="bottom-end" style="position: absolute; transform: translate3d(-112px, 37px, 0px); top: 0px; left: 0px; will-change: transform;">
